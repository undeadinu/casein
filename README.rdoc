...
Casein 6.0.0 has the following updates:

* Compatible with Rails 5.x
* Added auth_custom.js and auth_custom.css.scss for customizing JavaScript and CSS in the authentication layout

Version 6.0.0 should be a drop-in replacement for 5.1.1, but requires Rails 5.x and Ruby 2.1.x.

==What’s Was New in 5.1.1
...
<b>/assets/javascripts/casein/auth_custom.js & /assets/stylesheets/casein/auth_custom.css.scss</b>
