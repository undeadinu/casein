  ...
  describe 'field helpers' do
    ...
    describe "#casein_color_field" do
      it "builds an html5 color field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Color')
    ...
    describe "#casein_telephone_field" do
      it "builds an html5 telephone field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Telephone')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_search_field" do
      it "builds an html5 search field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Search')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_url_field" do
      it "builds an html5 url field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Url')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_email_field" do
      it "builds an html5 email field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Email')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_date_field" do
      it "builds an html5 date field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Date')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_datetime_field" do
      it "builds an html5 datetime field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Datetime')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_datetime_local_field" do
      it "builds an html5 datetime_local field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Datetime Local')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_month_field" do
      it "builds an html5 month field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Month')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_week_field" do
      it "builds an html5 week field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Week')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_time_field" do
      it "builds an html5 time field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Time')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_number_field" do
      it "builds an html5 number field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Number')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
    ...
    describe "#casein_range_field" do
      it "builds an html5 range field" do
        ...
        expect(field).to have_css('.form-group label.control-label', text: 'My Range')
        expect(field).to have_css('.form-group .well input.form-control')
      end
    end
